...
- **Overrides:** `OPT=-O3`. Otherwise the `decisions/0008` reference: `CRC_IMPL=table`,
...
`instret = 0001d91b` (121,115) · `crc_ref = 0x4cd4` · `acc = 0x33cc525d` · `iters = 0x3e8` · oracle **PASS**

## Notes

- Tests the prediction in `decisions/0008`: within ±20% of the -O2 figure (138,137). This run is
  -12.3%, inside the band. The outcome is recorded at the end of 0008.
