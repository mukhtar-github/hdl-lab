# spike-crc-rv32im-O2-no-crc-pass

- **Captured (UTC):** 20260925T084335Z
- **Command:** `make -C bench/rv32 check 'OPT=-O2 -fno-optimize-crc'`
...
- **Overrides:** 'OPT=-O2 -fno-optimize-crc'. Everything else is the Makefile at the commit above.
...
- Only the CRC pass disabled. -O2 then runs the source's loop made branchless (9 instructions every bit) and retires **more than -O1**. The pass alone put -O2 below -O1.
