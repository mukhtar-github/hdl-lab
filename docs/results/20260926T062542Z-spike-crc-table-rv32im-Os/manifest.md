# spike-crc-table-rv32im-Os

- **Captured (UTC):** 20260926T062542Z
- **Command:** `make -C bench/rv32 check OPT=-Os`
...
- **Overrides:** `OPT=-Os`. Otherwise the `decisions/0008` reference: `CRC_IMPL=table`,
...
`instret = 000265de` (157,150) · `crc_ref = 0x4cd4` · `acc = 0x33cc525d` · `iters = 0x3e8` · oracle **PASS**

## Notes

- Tests the prediction in `decisions/0008`: within ±20% of the -O2 figure (138,137). This run is
  +13.8%, inside the band. The outcome is recorded at the end of 0008.
