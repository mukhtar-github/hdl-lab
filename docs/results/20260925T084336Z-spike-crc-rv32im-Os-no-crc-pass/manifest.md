# spike-crc-rv32im-Os-no-crc-pass

- **Captured (UTC):** 20260925T084336Z
- **Command:** `make -C bench/rv32 check 'OPT=-Os -fno-optimize-crc'`
...
- **Overrides:** 'OPT=-Os -fno-optimize-crc'. Everything else is the Makefile at the commit above.
...
`instret = 000eada2` (961,954) · `crc_ref = 0x4cd4` · `acc = 0x33cc525d` · `iters = 0x3e8` · oracle **PASS**

## Notes

- Only the CRC pass disabled. -Os then also retires more than -O1.
