...
- **Overrides:** OPT=-O1. Everything else is the Makefile at the commit above.
...
`instret = 000c08d4` (788,692) · `crc_ref = 0x4cd4` · `acc = 0x33cc525d` · `iters = 0x3e8` · oracle **PASS**

## Notes

- `experiments/0001` sweep. No CRC pass at -O1: the source's loop, with a data-dependent branch per bit (5 or 9 instructions).
