...
- **Overrides:** OPT=-Os. Everything else is the Makefile at the commit above.
...
`instret = 0009e9aa` (649,642) · `crc_ref = 0x4cd4` · `acc = 0x33cc525d` · `iters = 0x3e8` · oracle **PASS**

## Notes

- `experiments/0001` sweep. The CRC pass fires at -Os too: the same table as -O2.
