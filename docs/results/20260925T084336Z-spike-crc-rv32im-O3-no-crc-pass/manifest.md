# spike-crc-rv32im-O3-no-crc-pass

- **Captured (UTC):** 20260925T084336Z
- **Command:** `make -C bench/rv32 check 'OPT=-O3 -fno-optimize-crc'`
...
- **Overrides:** 'OPT=-O3 -fno-optimize-crc'. Everything else is the Makefile at the commit above.
...
`instret = 0009fd3f` (654,655) · `crc_ref = 0x4cd4` · `acc = 0x33cc525d` · `iters = 0x3e8` · oracle **PASS**

## Notes

- Only the CRC pass disabled. **Same image hash as `spike-crc-rv32im-O3`**: at -O3 the pass had nothing left to match.
