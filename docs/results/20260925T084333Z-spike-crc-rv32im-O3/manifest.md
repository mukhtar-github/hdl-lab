...
- **Captured (UTC):** 20260925T084333Z
- **Command:** `make -C bench/rv32 check OPT=-O3`
...
- **Overrides:** OPT=-O3. Everything else is the Makefile at the commit above.
...
- `experiments/0001` sweep. The CRC pass is on at -O3 but never fires: early complete unrolling flattens the 8-bit loop first. See `spike-crc-rv32im-O3-no-crc-pass` — identical image.
